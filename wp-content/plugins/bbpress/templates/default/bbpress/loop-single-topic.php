...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<li class="bbp-topic-data">
		...
		<div class="topic_username">
			<?php
				echo '@'.bbp_get_topic_author_link( array( 'type' => 'name' ) );
			?>
		</div>
		<div class="topic_freshness">
			<?php do_action( 'bbp_theme_before_topic_freshness_link' ); ?>
			<?php bbp_topic_freshness_link(); ?>
			<?php do_action( 'bbp_theme_after_topic_freshness_link' ); ?>
		</div>
	</li>
	<li class="bbp-topic-counting">
		<div class="data"><span class="num"><?php bbp_show_lead_topic() ? bbp_topic_reply_count() : bbp_topic_post_count(); ?></span>&nbsp;<span class="label">replies</span></div>
	</li>
