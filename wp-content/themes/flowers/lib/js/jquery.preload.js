...
;(function( $ ){
	...
	var $preload = $.preload = function( original, settings ){
		...
		function handler( e ){
			...
			//-- 
			data.respuesta = $(this).parent().parent().find('input').attr('id');
			data.element = this;
			...
			data.indice = $(original[data.next-1]).parent().parent().find('input').attr('id');

			//console.log('->'+$(original[data.next-1]).parent().parent().find('input').attr('id'));
