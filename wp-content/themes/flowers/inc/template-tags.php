...
function post_nav() {
	...
	<nav class="container navigation post-navigation" role="navigation">
		<div class="nav-links row">
				...
				?>
					<div class="col-md-6 nav-prev">
						<?php
							//previous_post_link( '%link', __( '<span class="meta-nav">Previous Post</span>%title', 'twentyfourteen' ) );
							previous_post_link( '%link', __( '<span class="meta-nav">Previous Post</span><br/><span class="meta-title">%title</span>', 'twentyfourteen' ) );
						?>
					</div>
					<div class="col-md-6 nav-next">
						<?php
							//next_post_link( '%link', __( '<span class="meta-nav">Next Post</span>%title', 'twentyfourteen' ) );
							next_post_link( '%link', __( '<span class="meta-nav">Next Post</span><br/><span class="meta-title">%title</span>', 'twentyfourteen' ) );
						?>
					</div>
				<?php
				endif;
