...
function twentyfourteen_setup() {
	...
	add_image_size( 'twentyfourteen-full-width', 1024, 576, true );

	// This theme uses wp_nav_menu() in two locations.
	register_nav_menus( array(
		'primary' 		=> __( 'Primary Menu', 'twentyfourteen' ), 
		'secondary' 	=> __( 'Secondary Menu', 'twentyfourteen' ), 
		'tertiary' 		=> __( 'Tertiary Menu', 'twentyfourteen' ), 
	) );
...
//include(TEMPLATEPATH . '/functions_mod.php');
require get_template_directory() . '/functions_mod.php';

//include(TEMPLATEPATH . '/functions_mod.php');
require get_template_directory() . '/functions_util.php';
